...
let numberOfpotbellypig = 1

let numberOffish = 1

let numberOfsnakes = 1

let totalNumberOfAnimals = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters + numberOfpotbellypig + numberOffish + numberOfsnakes
let totalNumberOfMammals = numberOfDogs + numberOfCats + numberOfHamsters + numberOfpotbellypig
